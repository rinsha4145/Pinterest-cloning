...
const Create = () => {
  ...
  const handleSubmit = handleAsync(async (e) => {
    ...
    Object.keys(post).forEach((key) => {
      if (post[key] && key !== "tags") {
        // Exclude 'tags' since it's handled separately
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row w-full h-screen p-6">
        ...
        <div
          className="lg:w-1/3 flex flex-col items-center p-4 bg-white"
          onClick={handleClick}
        >
          <div
              ...
              {imagePreview ? (
                ...
                <>
                  ...
                  <p className=" text-xs text-center ">
                    ...
                    <br /> than 20MB or .mp4 files less than 200MB.
                  </p>
                  <input
                    type="file"
                    id="file-input"
